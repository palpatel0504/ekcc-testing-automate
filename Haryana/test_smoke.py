...
from run import (
    ...
    click_next,
    click_add_land,
    select_district_ambala,
    select_subdistrict_ambala,
    select_village_ambala_city,
    fill_survey_number,
...
def test_smoke_login_and_remove_loan(page):
    ...
    select_district_ambala(page)
    select_subdistrict_ambala(page)
    select_village_ambala_city(page)
